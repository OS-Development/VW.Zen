...
FloaterExploreSounds* FloaterExploreSounds::sInstance;

FloaterExploreSounds::FloaterExploreSounds(const LLSD& key)
:	LLFloater(key), LLEventTimer(0.25f)
{
	FloaterExploreSounds::sInstance = this;
}

FloaterExploreSounds::~FloaterExploreSounds()
{
	FloaterExploreSounds::sInstance = NULL;
}

BOOL FloaterExploreSounds::postBuild(void)
{
	...
	list->setDoubleClickCallback(boost::bind(&FloaterExploreSounds::handle_play_locally, this));
	list->sortByColumn("playing", TRUE);
	return TRUE;
}

LLSoundHistoryItem FloaterExploreSounds::getItem(LLUUID itemID)
{
...
// static
BOOL FloaterExploreSounds::tick()
{
...
// static
void FloaterExploreSounds::handle_play_locally(void* user_data)
{
	FloaterExploreSounds* floater = (FloaterExploreSounds*)user_data;
...
// static
void FloaterExploreSounds::handle_look_at(void* user_data)
{
	FloaterExploreSounds* floater = (FloaterExploreSounds*)user_data;
	LLScrollListCtrl* list = floater->getChild<LLScrollListCtrl>("sound_list");
...
// static
void FloaterExploreSounds::handle_stop(void* user_data)
{
	FloaterExploreSounds* floater = (FloaterExploreSounds*)user_data;
	LLScrollListCtrl* list = floater->getChild<LLScrollListCtrl>("sound_list");
	std::vector<LLScrollListItem*> selection = list->getAllSelected();
